...
"""
prob_prompt_text_2 = """Извлекайте только текст, который явно маркирован или отмечен как текст для самопробы. 
...
prob_prompt = PromptTemplate.from_template(prob_prompt_text_2)
