...
и те сообщения, из которых не понятно кого предстоит сыграть. Сообщения с приглашением на телепередачи и различные 
шоу тоже игнорируй. Отвечай в формате JSON, строго так, как описано в подсказке по форматированию {format_instructions}.
Текст сообщения: {input}"""
