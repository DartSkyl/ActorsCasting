...
{format_instructions}, все поля ОБЯЗАТЕЛЬНЫ для заполнения, ответ присылай в формате JSON. Обязательно использовать 
абсолютно все информацию из сообщения! Требуемый пол актера часто явно 
