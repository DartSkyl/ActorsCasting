...
самопроб в этом сообщении. Обычно, он указывается в сообщении в виде описания сцены и последующего диалога.
...
"текст для самопроб" или что то похожее. Если такого текста в сообщении нет, то просто ставь прочерк. Описание роли НЕ 
