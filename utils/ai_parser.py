...
- гонорар за роль.
ОБЯЗАТЕЛЬНО обращай внимание: если указано, например, "ищем мужчин и женщин в возрасте 
20-30 лет", то значит две отдельные роли - мужчина 20-30 лет и женщина 20-30 лет, "мальчики и девочки" это
